...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			JOptionPane.showMessageDialog(null,
					"Player health is " + playerHealth + " and dragon health is " + dragonHealth + ".");
	...
	static void dragonLost() {
		...
		// gold!
		JOptionPane.showMessageDialog(null,"You have defeated the dragon and obtained a ton of gold!");
